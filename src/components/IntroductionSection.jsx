...
const IntroductionSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (!tiltEl || !wrapEl || window.innerWidth < 768) return;
  ...
  return (
    <section
      ref={sectionRef}
      className="relative section-min-h-screen md:section-h-screen bg-ivory overflow-hidden px-[7vw] md:px-[5vw] py-[6vh] flex flex-col justify-center intro-short-container"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-[4vh] md:gap-[6vw] intro-short-grid">

        {/* IMAGE */}
        <div className="relative order-2 md:order-1">
          <div
            ref={imageWrapRef}
            className="relative w-full max-w-[260px] sm:max-w-[320px] md:max-w-[460px] mx-auto intro-short-image-wrap"
          ...
          >
            ...
            <div className="relative border border-charcoal/15 rounded-lg p-2 md:p-4 bg-ivory">
              <div
                ref={imageTiltRef}
        ...
        <div className="order-1 md:order-2">
          ...
          <h2 className="font-display font-normal text-charcoal leading-[0.95] text-[clamp(26px,6vw,48px)] md:text-[clamp(38px,4.5vw,68px)] max-w-[18ch] intro-short-title">
          ...
          <p className="mt-4 md:mt-6 max-w-[48ch] text-stone text-[14px] md:text-[17px] leading-[1.8] intro-short-paragraph">
          ...
          <p className="mt-3 md:mt-4 max-w-[48ch] text-stone text-[14px] md:text-[17px] leading-[1.8] intro-short-paragraph">
          ...
          <div className="mt-6 md:mt-8 intro-short-button-wrap">
            <a
              href="/master-profile"
